                ...
                <th t-else=""
                    ...
                    <t t-if="cell.column.hasLabel and cell.column.widget !== 'handle'">
                        ...
                        <div class="d-flex align-items-center"
                            ...
                            <i class="o_list_sortable_caret" t-att-class="getSortableIconClass(cell.column)"/>
                        </div>
...
patch(ListRenderer.prototype, {
    ...
    openHeaderEditor() {
        this.dialogService.add(HeaderEditor, {
            ...
            save: async (newConfig, centerHeaders) => {
                ...
                // Mutate in-place so OWL's reactive proxy detects the change
    ...
    get nbCols() {
        let n = super.nbCols;
        // The fallback merge-edit column is only added when there is no native
        // actions column but the user can edit headers.
